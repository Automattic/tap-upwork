...
GENERIC_ORGANIZATION_PROPERTIES = PropertiesList(
    ...
    Property('active', BooleanType, description='Indicates whether this organization is active.'),
    Property('hidden', BooleanType, description='Indicates whether this organization/team is hidden.'),
...
TIME_REPORT_PROPERTIES = PropertiesList(
    ...
    Property('freelancer', GENERIC_USER_PROPERTIES, description='User associated with the time report'),
    Property('team', GENERIC_ORGANIZATION_PROPERTIES, description='Team associated with the time report'),
    Property('task', StringType, description='Task associated with the time report'),
    Property('taskDescription', StringType, description='Task description associated with the time report'),
    Property('memo', StringType, description='Memo associated with the time report'),
    Property('totalHoursWorked', NumberType, description='Total hours worked for the time report'),
    Property('totalCharges', NumberType, description='Total charges made for the time report'),
    Property('totalOnlineHoursWorked', NumberType, description='Total online hours worked for the time report'),
    Property('totalOnlineCharge', NumberType, description='Total charges made for online work for the time report'),
    Property('totalOfflineHoursWorked', NumberType, description='Total offline hours worked for the time report'),
    Property('totalOfflineCharge', NumberType, description='Total charges made for offline work for the time report'),
)
